                    ...
                    <div class="card-inner">
                        ...
                        <ul class="nk-stepper-nav nk-stepper-nav-s1 stepper-nav is-vr">
                          ...
                          <li class="current">
                            ...
                            <li @if (!empty($service) && $service->approval_status ==1 )
                            class="current"
                            @else
                            class=""
                            @endif>
                            ...
                            <li @if(!empty($documents1) && $documents1->payment_status == 1 )
                            class="current"
                            @else
                            class=""
                            @endif>
                            ...
                            <li @if(!empty($inspection_payment))
                                class="current"
                                @else
                                class=""
                                @endif>
                                <div class="step-item">
                                    <div class="step-text">
                                        ...
                                        <div class="sub-text">
                                            ...
                                            Inspection Fees of <b>{{ $settings['site_currency_symbol'] }}{{ number_format($inspection_payment->amount,2) }}</b> has been paid
                                            @if($notify)
                                            <p class="noti-details"><span class="noti-title">{{ 'Message: '.$notify->data }}</span></p>
                                        <p class="noti-time"><span class="noti-title">{{ 'Date: '. \Carbon\Carbon::parse($notify->type)->format('F j, Y H:i:s') }}
                                        </span></p>
                                        @endif
                            ...
                            <li @if(!empty($inspection_payment) && $inspection_payment->approval_status == 1 )
                                class="current"
                                @else
                                class=""
                                @endif>
                                <div class="step-item">
                                    <div class="step-text">
                                        ...
                                        <div class="sub-text">
                                            ...
                                            Inspection Fees of <b>{{ $settings['site_currency_symbol'] }}{{ number_format($inspection_payment->amount,2) }}</b> has been confirmed and approved
                            @else
