                ...
                <div class="row custom-invoice">
                    ...
                    <div class="col-6 col-sm-6 m-b-20">
                        <div class="invoice-details">
                            ...
                            <ul class="list-unstyled">
                                <li>Date: <span>{{ \Carbon\Carbon::parse($pending->created_at)->format('F j, Y') }}</span></li>
                                <li>Due date: <span>{{ \Carbon\Carbon::parse($pending->created_at)->format('F j, Y') }}</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-6 col-lg-6 m-b-20">
                        <div class="invoices-view">
                            ...
                            <ul class="list-unstyled invoice-payment-details">
                                <li>
                                    <h5>Total Due: <span class="text-right">{{ $settings['site_currency_symbol'] }}{{ $pending->amount }}</span></h5>
                                </li>
                                ...
                                <div class="table-responsive no-border">
                                    <table class="table mb-0">
                                        <tbody>
                                            <tr>
                                                <th>Subtotal:</th>
                                                <td class="text-right">{{ $settings['site_currency_symbol'] }}{{ $pending->amount }}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right text-primary">
                                                    <h5>{{ $settings['site_currency_symbol'] }}{{ $pending->amount }}</h5>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
...
<script>
    function printDiv(divId) {
        ...
        printWindow.document.write('<html><head><title>NIWA_Registration_Fee</title></head><body>' + content + '</body></html>');
