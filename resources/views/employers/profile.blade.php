    ...
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title">Client Profile</h3>
                    ...
                    <div class="preview-block">
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="form-group">
                                    <div class="form-control-wrap">
<label class="form-label">Area Office Name</label>
                                        <span class="form-control">{{ auth()->user()->branch->branch_name ?? 'NILL' }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-6">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="form-group">
                                    <div class="form-control-wrap">
                                        ...
                                        <span class="form-control">{{ auth()->user()->state->name ?? 'NILL' }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-6">
