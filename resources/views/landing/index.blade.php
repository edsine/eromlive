                ...
                <div class="col-lg-6 col-md-10">
                    <div class="header-hero-content">
                        <h3 class="header-title wow fadeInLeftBig" data-wow-duration="1.3s" data-wow-delay="0.2s">
                            Welcome to the NIWA Self Service Portal</h3>
                        <p class="text wow fadeInLeftBig" data-wow-duration="1.3s" data-wow-delay="0.6s">Welcome to
                            a new era of service interaction with the National Inland Waterways Authority. Harness
                            the power of NIWA and experience a future where administrative tasks are effortless,
