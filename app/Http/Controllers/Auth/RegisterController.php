 ...
 */
    ...
    public function saveregidtrationform(Request $request)
    {
        ...
        // $validatedrecord= Validator::make(
        //     [

        //         'user_type'=>'required',
        //         'contact_firstname'=>'required|string',
        //         'contact_surname'=>'required|string|min:5',
        //         'company_phone'=>'required',
        //         'company_email'=>'required|unique:employers',
        //         'password'=>'required',
        //         'status'=>'required'
        ...
        return redirect()->route('login')->with('success','REGISTRATION SUCCESSFUL AWAITING APPROVAL FROM AREA MANAGER');
    }
